...
```
Use Git Commit & Push Agent: Commit and push my changes with type "feat" and scope "coinjoin"
```

### What It Does
1. ✅ Checks current branch (aborts if on main/master, creates feature branch)
...
**Feature commit:**
```
Use Git Commit & Push Agent to commit this feature: Add Nostr relay integration
```

**Fix commit:**
```
Git Commit & Push Agent: Commit fix for memory leak in pool coordination
```
...
**With specific title:**
```
Use GitHub PR Creation Agent: Create PR titled "Add Nostr relay integration"
```
...
**Feature PR:**
```
Use GitHub PR Creation Agent to create PR for the CoinJoin pool feature
```
...
**Review by URL:**
```
GitHub PR Review Agent: Review this PR https://github.com/owner/repo/pull/42
```
...
5. ✅ **Security review for Bitcoin/CoinJoin code**
6. ✅ Provides actionable feedback
7. ✅ Optionally approves or requests changes
...
**Detailed review:**
```
GitHub PR Review Agent: Do a comprehensive review of PR #45, check for memory leaks and security issues
```
...
```
GitHub PR Review Agent: Review PR #45 focusing on security and CoinJoin logic
```
...
- ✅ **Security findings for Bitcoin/CoinJoin code**
...
**Merge by URL:**
```
GitHub PR Merge Agent: Merge this PR https://github.com/owner/repo/pull/152
```
...
- Type: feat
- Scope: coinjoin
- Subject: Implement Nostr-based pool coordination
- Body: Added NostrRelayManager with retry logic
- Closes: #12
```
...
- Title: [FEATURE] Add CoinJoin pool creation
...
**If on main branch:**
The agent will automatically abort and create a feature branch. You can also switch manually:
```bash
...
1. **Be Specific**: The more context you provide, the better the results
   - ✅ "Use Git Commit & Push Agent to commit this CoinJoin feature"
   - ❌ "Commit"
...
**Developer:** "I've implemented the Nostr relay integration. Use Git Commit & Push Agent to commit this."

**Git Commit & Push Agent Response:**
- ✅ Checks branch (feature/nostr-relay-integration)
- ✅ Runs tests (all pass)
- ✅ Generates commit: `feat(nostr): implement Nostr relay integration for CoinJoin pools`
- ✅ Pushes to remote
...
**Git Commit & Push Agent:**
- ✅ Commit: `fix(memory): resolve memory leak in CoinJoin pool coordination`
- ✅ Pushes changes
